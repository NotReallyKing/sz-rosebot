...
home_keyboard_pm = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton(
                text="👥 Support Chat",
                url=f"https://t.me/tgcalls_MusicXchat",
            ),
            InlineKeyboardButton(
                text="🔰News Channel",
                url=f"https://t.me/PytgMusicUpdates",
            )
        ],
    ]
)
...
IMG = ["https://telegra.ph/file/d2178f99282b79d5ca1b0.jpg",
...
[👋]({random.choice(IMG)}) Hey there {message.from_user.mention}, 
   ...
   My name is Devil, an  advanced telegram Group management Bot For helpYou Protect Your Groups & Suit For All Your Needs. 
I currently manage about `{len(served_chats)}` groups.I have over `{len(served_users)}` users

⚒ Send Me /help For Get Commands. 
👨‍💻Dᴇᴠᴇʟᴏᴘᴇʀ : @AttitudeKing_vj
""",
...
👋 Hey there {CallbackQuery.from_user.mention}, 
   ...
   My name is Devil ,an  advanced telegram Group management Bot For help 
